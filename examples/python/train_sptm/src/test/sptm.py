...
class InputProcessor:
  def __init__(self):
    if EDGE_NETWORK in [SIAMESE_NETWORK, JOINT_NETWORK]:
      # edge_model_path = EDGE_MODEL_WEIGHTS_PATH
      edge_model_path = '../../experiments/trained_updated_800/models/model.000800.h5'
      self.edge_model = load_keras_model(2, 2, edge_model_path, EDGE_NETWORK)
