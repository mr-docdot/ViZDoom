...
if __name__ == "__main__":
    ...
    vid_out = cv2.VideoWriter('doom.avi',
                               cv2.VideoWriter_fourcc(*'X264'),
                               vzd.DEFAULT_TICRATE, (640, 480))

    print(vzd.DEFAULT_TICRATE, vid_out)
    ...
    for i in range(episodes):
        ...
        while not game.is_episode_finished():
            ...
            #ret = vid_out.write(screen_buf)
            vis_buf = cv2.cvtColor(labels_buf, cv2.COLOR_GRAY2BGR)
            print(vis_buf.shape)
            ret = vid_out.write(vis_buf)
